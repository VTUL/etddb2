...
for availability in availabilities do
  Availability.create(name: availability[0], description: availability[1], reason: Reason.where(name: availability[0]).first, retired: false)
end

for availability in retired_availabilities do
  Availability.create(name: availability[0], description: availability[1], reason: Reason.where(name: availability[0]).first, retired: true)
end
